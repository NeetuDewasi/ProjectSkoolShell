<template>
    <div>
        <div class="dashboard-content-one">
            <Breadcrumb pageTitle="School Dashboard" :breadcrumbList="breadcrumbList" />
            <div class="row gutters-20" >
                <StatsCard :stats="statsItem" v-for="(statsItem, index) in stats" :key="index" />
            </div>
            <div class="row gutters-20">
                        ...
                        <div class="card-body">
                            ...
                            <div class="notice-box-wrap">
                                <div class="notice-list">
                                    ...
                                    <h6 class="notice-title"><a href="#">Great School manag mene esom text of
                                            the
                                            printing.</a></h6>
...
<script>
	import StatsCard from "./DashboardStatsCard.vue";
	export default {
				...
				stats: [
					{
						title: "Students",
						value: "1,50,000",
						icon: "flaticon-classmates text-green",
					},
					{
						title: "Teachers",
						value: "2,250",
						icon: "flaticon-multiple-users-silhouette text-blue",
					},
					{
						title: "Parents",
						value: "5,690",
						icon: "flaticon-couple text-orange",
					},
					{
						title: "Earnings",
						value: "1,93,000",
						icon: "flaticon-money text-red",
					},
				],
			};
		},
